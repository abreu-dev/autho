namespace Autho.Principal
{
    public class ProfileAppService : IProfileAppService
    {
        ...
        public IResult Add(ProfileCreationDto creationDto)
        {
            ...
            {
                return new Result(ResultType.Failure, new ResultError("AlreadyUsed", "Already Used", "Name already in use."));
            }
        ...
        public IResult Update(Guid id, ProfileCreationDto creationDto)
        {
            ...
            if (profile == null)
            {
                return new Result(ResultType.Failure, new ResultError("NotFound", "Not Found", "Profile was not found."));
            }
        ...
        private IResult ValidatePermissions(IEnumerable<ProfilePermissionCreationDto> permissions)
        {
            if (permissions != null)
            {
                ...
                if (duplicatedPermissions.Any())
                {
                    ...
                    {
                        result.Errors.Add(new ResultError("Duplicated", "Duplicated", $"Permission '{duplicatedPermission.Key}' is duplicated."));
                    });
                    return result;
                }
                ...
                if (failedPermissions.Any())
                {
                    ...
                    {
                        result.Errors.Add(new ResultError("NotFound", "Not Found", $"Permission '{failedPermission}' was not found."));
                    });
                    return result;
                }
            }
